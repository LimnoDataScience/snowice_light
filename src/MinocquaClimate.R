...
clim = read_csv('field//GHCND_USC00475516_Minocqua.csv') |> 
  ...
  mutate(group = case_when(DATE >= as.Date('2018-10-01') & DATE <= as.Date('2019-05-01') ~ 'Winter 18-19',
                           DATE >= as.Date('2019-10-01') & DATE <= as.Date('2020-05-01') ~ 'Year 2',
                           DATE >= as.Date('2020-10-01') & DATE <= as.Date('2021-05-01') ~ 'Year 3'))
