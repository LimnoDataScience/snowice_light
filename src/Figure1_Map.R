...
ssb <- data.frame(site = c("South Sparkling Bog", "Trout Bog"),
                                lat = c(46.003285, 46.041324),
                                lon = c(-89.705346, -89.682232)) %>%
...
ggsave('figs/Figure1_Map.png', width = 6.5, height = 3, dpi = 500, bg = "transparent")
